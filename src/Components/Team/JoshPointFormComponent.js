    ...
    <div className={classes.container}>
      <div className={classes.pointRow}>
        <Typography variant="body2" className={classes.pointRowText}>
          ...
          musical facility is located on the top floor of The Steakhouse.{' '}
          <span className={classes.red}>“Studio C”</span> is where Joshua now
          produces many new artists and worked on Grammy Award winning records.
          Over the years Joshua has recorded / performed on sessions with{' '}
          ...
          <span className={classes.red}>James Baker &amp; Lonnie Jordan</span>{' '}
          ...
          and
          <span className={classes.red}> Jeff Millar-Sax</span>. Additionally,
